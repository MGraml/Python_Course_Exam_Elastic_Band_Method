...
#%%
res = opt.minimize(Energy,band_list[1:-1],args=(band_list[0],band_list[-1],x,y,Z),method = 'BFGS',options={'maxiter' : 20, 'eps' : 1.1,'disp':True})
...
plt.scatter(x_init,y_init, c='green')
...
plt.scatter(x_final,y_final,c='red',s=2)
plt.show()
